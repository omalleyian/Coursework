...
void init()
{
	...
	ShaderInfo shaders[] =
	{
		{ GL_VERTEX_SHADER, "//Hams-cs/coms 331/Koether/Assignments/Assignment 1/Rectangle.vert" },
		{ GL_FRAGMENT_SHADER, "//Hams-cs/coms 331/Koether/Assignments/Assignment 1/Rectangle.frag" },
		{ GL_NONE, NULL }
	};
